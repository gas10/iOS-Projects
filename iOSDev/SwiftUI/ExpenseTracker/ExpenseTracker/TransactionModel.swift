...
extension Category {
    ...
    static let billsAndUtility = Category(id: 2, name: "Bill & Utility", icon: .file_invoice_dollar)
    ...
    static let moviesAndDVD = Category(id: 301, name: "Movies & DVD", icon: .film, mainCategoryId: 3)
...
extension Category {
    ...
    static let subCategory: [Category] = [
        .publicTransport,
        .taxi,
        .mobilePhone,
        .moviesAndDVD,
    ...
    static let all: [Category] = category + subCategory
}
